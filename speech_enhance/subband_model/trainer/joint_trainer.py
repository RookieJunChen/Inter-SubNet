...
from audio_zen.loss import si_snr
...
class Joint_Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for noisy, clean in self.train_dataloader:
            ...
            with autocast(enabled=self.use_amp):
                ...
                mask_loss = self.loss_function(ground_truth_cIRM, cRM)
                # 还原为Wav计算一波Loss
                ...
                snr_loss = si_snr(enhanced, clean)
                print(mask_loss)
                print((snr_loss / 250))
                loss = mask_loss + 0.1 * (snr_loss / 250)
    ...
    def _validation_epoch(self, epoch):
        ...
        for i, (noisy, clean, name, speech_type) in enumerate(self.valid_dataloader):
            ...
            mask_loss = self.loss_function(cIRM, cRM)
